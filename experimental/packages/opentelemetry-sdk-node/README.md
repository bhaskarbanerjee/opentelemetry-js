...
| OTEL_METRICS_PUSH_EXPORTER_INTERVAL    | The export interval when using a push Metric Reader. Default is `60000`.   
| OTEL_METRICS_PUSH_EXPORTER_TIMEOUT    | The export timeout when using a push Metric Reader. Default is `30000`. 
